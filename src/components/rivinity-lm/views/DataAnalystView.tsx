    ...
    <div className="max-w-[750px] mx-auto">
      ...
      {hasData && (
        <>
          ...
          {/* Data table preview */}
          <div className="glass rounded-2xl border border-glass p-5 mb-6 shadow-float overflow-x-auto">
              ...
              <thead>
                <tr className="border-b border-border/40">
                  {["Student", "Math", "Science", "English", "Average"].map(h => (
                    <th key={h} className="text-left py-2 px-3 text-muted-foreground/50 font-semibold">{h}</th>
                  ))}
                </tr>
              </thead>
              <tbody>
      ...
      {/* Query */}
      <div className="glass rounded-2xl border border-glass p-4 shadow-float">
        <div className="flex items-center gap-2">
