...
const DashboardContent = () => {
  ...
  return (
    <div className="w-full flex-1 min-h-0 overflow-y-auto bg-background text-foreground selection:bg-primary/20 antialiased">
      <motion.main
        variants={containerVariants}
        initial="hidden"
        animate="visible"
        className="max-w-7xl mx-auto px-4 md:px-6 py-8 md:py-12 space-y-12 sm:space-y-16"
      >
        {/* HERO / PROMPT BAR */}
        ...
        <motion.section variants={itemVariants} className="w-full space-y-4">
          ...
          <div className="w-full surface-interactive rounded-2xl sm:rounded-3xl divide-y divide-border/40 overflow-hidden">
